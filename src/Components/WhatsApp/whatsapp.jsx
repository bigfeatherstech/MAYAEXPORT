...
const WhatsApp = () => {
  ...
  const phoneNumber = '91'; // Replace with your actual WhatsApp number
  const message = 'Hello! I would like to get more information about your products and services.';
  ...
  return (
    <div className="fixed right-6 z-50" style={{bottom:"15%"}}>
      {/* WhatsApp Button */}
      <div
      ...
      >
        ...
        <div
          className={`hidden lg:block absolute right-14 top-1/2 transform -translate-y-1/2 bg-gray-900 text-white px-3 py-2 rounded-lg shadow-lg transition-all duration-300 ${
